         ...
         <div class="flex-grow-1">
             <ul class="menu-list mt-3 rounded-4">
                 ...
                 <li class="brand-icon mb-3 py-1">
                     <a href="index.html">
                         <img class="img-fluid top-0" src="{{asset('assets/img/logo.png')}}" alt="" srcset="" width="100"
                             height="100">
                 ...
                 <!--[ Start:: Account ]-->
                 @if (PermissionHelper::hasGroupPermission(1))
                     <li class="collapsed">
                 ...
                 @if (PermissionHelper::hasGroupPermission(2))
                     <li class="collapsed">
                 ...
                 @if (PermissionHelper::hasGroupPermission(3))
                     <li class="collapsed">
                         ...
                         <ul class="sub-menu collapse {{ request()->is('admin/booking-management*') ? 'show' : '' }}"
                             ...
                             @if (PermissionHelper::hasSpecifiPermission('customer.list'))
                                 <li><a class="ms-link {{ request()->is('admin/user-management/customer*') ? 'active' : '' }}"
                                         href="{{ route('customer.list') }}">Customer</a></li>
                             @endif
                             @if (PermissionHelper::hasSpecifiPermission('plot-registry.create'))
