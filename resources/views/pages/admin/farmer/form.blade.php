<div class="row " id="inputParent">
    ...
    <div class="col-lg-3 col-md-6">
        ...
        <select class="form-control show-tick   select2" multiple data-placeholder="Select" name="site_id[]">
    ...
    <div class="col-lg-3 col-md-6">
        ...
        <select class="form-control show-tick   select2" data-placeholder="Select" name="state_id" id="state_select">
            <option id="">--Select--</option>
    ...
    <div class="col-lg-3 col-md-6">
        ...
        <select class="form-control show-tick   select2" data-placeholder="Select" name="city_id" id="city_select">
            <option id="">--Select--</option>
    ...
    <div class="col-6 mt-3">
        <span class="float-label">
            <textarea class="form-control form-control-lg" id="TextInput" name="address" id="">{{ $farmer ? $farmer->address : '' }}</textarea>
